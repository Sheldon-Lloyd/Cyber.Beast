...
- Episodes: 22-27
- Roles
  - Broadcaster/Commentator: Spike, Max?
  - Fan: Max
...
##	Act 1
### 1. Ordinary World
Episodes: [1](https://github.com/Sheldon-Lloyd/Cyber.Beast/tree/Cyber.Beast(Max)/comic/Max/episode-1)
- Max watches Championships
	
	- **Xenos loses the Championships**
			**Shown as an early flash back:**
			After Xenos loses and Max who is fan of him runs up to him(maybe a younger Max) and says I don't like you any more.

			
### 2. Call To Adventure
Episodes: [2](https://github.com/Sheldon-Lloyd/Cyber.Beast/tree/Cyber.Beast(Max)/comic/Max/episode-2), [3](https://github.com/Sheldon-Lloyd/Cyber.Beast/tree/Cyber.Beast(Max)/comic/Max/episode-3)
	- Max Applies to be a Cybervator
	- Max heads back home
	- Airiona is seen escaping the hub Max was at
	- When Max arrives home an injured Airiona is found at the foot of his door

- The reader sees the inside of Max’s room which has posters and cybervator Fandom items everywhere
- Max uses this opportunity to test his Cyber.Beast controller using Airiona's Cyber.Beast 
...
- Max tends to the injured Airiona fixing her CSD which allows her to heal. she encourages him to try again and that she will give word to her superiors to give him a chance and that they will send him a Cyber.Beast so that he can test his device.

### 3. Refusal Of The Call
Episodes: [4](https://github.com/Sheldon-Lloyd/Cyber.Beast/tree/Cyber.Beast(Max)/comic/Max/episode-4)
		
	
- Max is given a Cyber.Beast and invited to be a cybervator
	- Max takes the cyber.beast given to him by Xenos/Airiona inviting him to join the Cyvolters which he in excitement misread as cybervators
...
- Max teams up with Airiona in cyberspace.
	- When Max logs into cyberspace it is recommended that he choose an alias in which he chooses Max
	- Max is about to mine cyber.beast or fight another cybervator alone He spots a girl that waves at him but he doesn't know who she is so he he casually ignores her
		...
		Max: wait aren't you(showing image of her waving)
...
Airiona gets back in contact with Max and explains what they are about. Max decides to join as he does not want to tell Spike the truth knowing that he will try to capitalize on this info by broadcasting it. 
		
##	Act 2
### 5. Crossing The Threshold
Episodes: 6, 7
	
- Max and maybe Airiona lose their first ranked/unranked fight and prepare for a second. They lose to Jax who does not let up and Jax nearly takes his only cyber.beast. Max ejects just in time An announcer is either surprised that he even has a fan and laughs at the fact the he only has one fan probably because ever saw his first fight in which he did terrible. Spike is that only fan
- Spike wanted him to join his company which is secretly helping the Cyvolter organization.

- Max takes the criticisms of Spike and improves the controller he made

- Max develops Airiona's character as he gets her to not only help other citizens in cyberspace but Cybervators as well.
	
	They help them mostly by teaming up with ReNet, BluNet, and Cyvolter Cybervators that are being out numbered
	
		
- Max trained his body
...
- Max has customized his Cyber.Beast and CSD to have a talking Ai which he calls Torrey
	
- Mini falls in the backyard of Max

	Max goes to call for help but remembers that Airiona says that it takes hours to fix CSDs. And that if he does not fix it soon she might never recover or worse dies. 
...
- Max tells a worried Spike what happen
		
	it is placed on the news Minia teleports to Max enraged that he told. He is seen taking a shower and is wearing his headband/glasses Minia asks him why he wears even while in the shower. He tells her that it is a keepsake from his parents that he doesn't want to lose. He tells her their names where Torrey and Mack.
...
- Max helps someone in cyberspace 
...
- Max looks ahead to see who his team may be if he earns a spot
	
- Max loses to Jax 
	
	This team consists of Minia and Jax	

- Max is seen outside of cyberspace
	
	Max has not been seen out side of cyberspace for a while but when we see him he now has hair on his head and no longer has a fat belly.		
		
- Now having a Cyber.Beast Max has customized his CSD to have a hologram of a bird(owl?)
		
- Max learns that Airiona is a cyvolter and he may have been helped them
### 7. Approach To The Inmost Cave
Episodes: 13, 14, 15

- More citizens are now competing in the CNS league thanks to the Cyvolters distributing the tech that Max made
	
- Max finds old cyber.tech
		
	Max realizes that even if he makes it into the tournament he won't be of much help since he can't go into a BurstDrive mode.
...
- Minia helps Max who is bullied
		Max is watching a CNS broadcast while at the gym and is wearing headphones maybe visor headphones 
		
	Max uses his UBI credit to become the sponsor of the cheapest cybervator he could find. Akia/Spike tells him he spent more money than he can make in a year as he buys majority of her stock shares in credit. He does not know how much money he has made as a cybervator an maybe doesn't even know he is a cybervator.

			
		
	Max is getting bullied first they verbally abuse him. Akia tells haha look at Max trying to get buff you think that just because you are getting in shape you will become a cybervator. lets see what you got. They then begin pushing him at this point the alert system on his CSD turns yellow or orange at which point the CSD says the threat level and ask Max if he would like assistance he says no. one of the bullies Akia his it turned orange/yellow the leader then says don't worry the Cybervators will only come if it turns red or Max asks for help which he says would never happen. 
		
	It appears like he might stand up for his self but he doesn't. Just as Max is pushed or about to be pushed to the ground Minia appears the bullies run away. After they run away Max ask what are you doing here and she's say I'm your Nia remember. Minia asks Max if he is alright to which he replies that he is fine and that they are just bullies and tells her thanks but that he didn't need her help and that it never reached level red and she says she just happened to notice it rising and decided to intervene on her own “and besides I was bored anyway”

- Max might not have enough points
...
- Max is laughed at by a broadcaster maybe Akia for the fact that  he may have managed to become a highly ranked Cybervator but does not have an Tail let alone his missing arm and leg(s) so even if he makes it to the championship how does he expect to doing anything with out being able to go into burst drive mode.
	
- Max loses a match and with it his cyber.beast which pretty much eliminates any chances of making it into the championships
		
- Alex becomes chief
- Max works on his new tech
	
	
### 8. Ordeal
Episodes: 16
- Max is given/finds a new cyber.beast or the one he beats gives him his Cyber.Beast back as they know how much he helped others and wants to return the favor.
	...
	Jax and Max fights which is watch by none/many as no one expect a match at this time.

	Max fairs well but time is running out. At this point Jax forfeits knowing that he has a huge lead as the number one ranked cybervator.

	Jax: Don't get any ideas I'm just paying back the favor. 
		
	*Flash back of Jax shown hugging Minia after Max saved her*

	Minia is surprised that he knew there was not much time left as he normal has a bad concept of time. He tells her Max but he never said anything out loud

- Someone  asks if he is Upset that he was handed the spot rather than earning it on the team Max tell Alex/Xenos/Minia/Jax/Akia/Airiona that it does matter that it is just a game. They reply telling him that is his problem/Thats why I can stand you/Its not just a game

	Max is told that it is not just a game but that it the reason that we have no more wars and maintain peace among citizens as it gives people a place to belong satisfying the human desire for tribalism
...
- Alex tells the NRA that both Citizens and Cybervators has taken a liking to Max and that their no telling how they might respond if they don't let him compete. They discuss the possibility of angering the citizens if they don't let him compete citing the decrease in ReNet stock as an example.

- Alex allows Max to compete with BluNet or offers up Kassiea/Xenos' hub allowing Max to compete	
...
- Minia is traded to BluNet by Leona which is all over the news. 
	...
	- Kyshumu is enraged as this is right before the hub she is traded to becomes a Cyvolter hub. He then realizes this is the perfect opportunity to ensure Max loses -- he tells her to throw the match. This leaves Minia conflicted because she does not want to see Max fail.
	
- Max uses his tech to compete in the CNS championships
	
	Airiona: Wow I thought what you made before was incredible how did you create this stuff
		
	Max: I didn't make it. Its I made from tech that I found under my house(the hole Minia/Airiona created). A lot of it was unfinished All I did was make a few modifications
		
	Max: I call it an Elimiter. Normally a cyber.beast would be able to synergize with a cybervator thanks to thier tail. Since everybody including cybervators evolved from plants I used a plant to act as the cyber.beast[1](https://www.engadget.com/2018/12/05/mit-researchers-create-a-robot-houseplant-that-moves-on-its-own/),[2]( https://www.theverge.com/2018/7/12/17563688/robot-plant-hybrid-hexa-vincross-succulent ). 
...
- Harmony attacks Max who tries to introduce his self a nearly kills him but she stops which surprises Ace
...
After seeing both seeing the backs of both Airiona and Minia Max looks confused Xenos sees him looking maybe makes a quip then proceeds to explain the reason that Aironia has so many scars compared to Everyone else and why Minia has none
...
- Max is fighting on Akia's favorite Cybervators team

	Max runs into Akia before his championship match.

	Akia: Hey Max(She looks as if she will punch/hit him)
...
- An ultimatum/wager is purposed for Max
	
	With Max joining ReNet Kyshumu tells the CNS/NRA that no Citizen should be allowed to compete in the CNS.

	The CNS' Yaharia  makes a ultimatum suggesting that a citizen is unlikely to win the championships--If Max loses no Citizen will be allowed to compete in the CNS again.
...
- Xenos gets injured and gets a limb or two cut off and Avis is missing
	...
	- Airiona tells Max that Minia is sabotaging them. Max(he was voted team captain despite not starting) then suggests that Minia be removed from her Blue position. Airiona is happy thinking Minia is being bench--however Max bench's Airiona instead who is visibly upset. Someone asks then who will take the Blue/White position (Harmony(can't)/Xenos(injured)/Avis (missing)). 
	
		Max: well then I guess Air...
		
		Xenos: You should Max. It will be the perfect chance to show everyone what you're capable of.
		
		Airiona: are you crazy he doesn't have a BurstDrive he'll get his self killed
		
		Max: Actually! He might be a genius. You see Jax is a lot like Minia and the last person on that team that would kill anyone. There is no telling how much he will hold back against a Citizen like me. But what I do know is that his biggest weakness will become our strength.
		
	- After Max is substituted in
	 ...
	 - Yaharia takes notice of Max as she realizes that he is using ancient tech that was locked up and hidden centuries ago
## Act 3
### 11. Resurrection
Episodes: 20, 21
- Max fights Jax
...
Episodes: 22
running circles around Max does a spend being slower this gives him more mobility allowing ace to shot and score. he tries a second time thinking he has the upper hand but Jax is ready for it

Max acts as if he will slide under Jax who punches the ground breaking it sending debris upwards which Max rides the debris allowing him to dos an aerial attack.

- Knilla allow Max to ride after Ace cites what she said earlier
	Knilla start running and says Max(who turns around)! jump on.

	Max takes he lance as she runs through Jax Max opens the barrier and they are able to collect points

	Max ride Knilla again this time he jumps with her lance off hoping the momentum from Jax giving chase would create an opening. However he is shot at instead. The cybervator shots only at his feet but this enough to send a citizen like him flying backwards.

	Max starts to question why everyone is afraid to hit him. he then questions why he himself is upset by this as it was the plan after all. He states he can once again take advantage of the debris created by the blast.
...
- Max uses his trump card utilizing the energy bean he ate earlier this allows him to partially synergize with the cost of depleting all of his energy with the risk of killing him.
...
- In the final seconds of the match amidst a comeback
	...
	Max: <Is he afraid of hurting me?>
		
	Max: Jax! Don’t hold back/Give it all you got/Stop holding back
		
	Jax: < he's right if I lose now Max won't be the only citizen who’s life will be at risk >
		
	Max: why did I say that I have to win 
		so that everyone will have the right compete
		I am fighting so that all citizens will have the right to compete
		
	Max: is it from the Cyber.Beast. No that's not it this feeling--this is what it means to truly compete/be a cybervator

	
- Max wins/loses(do to the unforeseen random nature of Jax) championship
	
	If Max wins it is because Tomasina lets him or is distracted by the fact that he looks/feels familiar
